...
?>
   ...
   <div class="section is-brand-bg is-sm">
      <div class="container">
         ...
         <div class="section__head is-border">
            <div class="section__head-row row">
               ...
               <div class="col-lg-6 text-lg">
                  Мы ищем талантливых и мотивированных профессионалов, <br>
                  которые готовы внести свой вклад в нашу компанию и <br>
         ...
         <?php if (have_posts()) : ?>
            <div class="row row-cols-md-2 row-cols-1 vacancies-row js-load-more-container">
         ...
         <?php if ($wp_query->max_num_pages != 1) : ?>
            <div class="text-center">
               <button
                  ...
                  data-post-type="vacancy"
                  data-action="vacancy_load_more"
